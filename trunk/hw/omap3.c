                            ...
                            uint32_t value)
{
    ...
    case 0x68 ... 0x6b:
        ...
        s->l3_pm_rt_req_info_permission[i] &=
            (~(0xff << ((offset - 0x48 - i * 0x20) * 8)));
        s->l3_pm_rt_req_info_permission[i] |=
            (value << (offset - 0x48 - i * 0x20) * 8);
        break;
    case 0x50 ... 0x53:
    case 0x70 ... 0x73:
        i = (offset - 0x50) / 0x20;
        s->l3_pm_rt_read_permission[i] &=
            (~(0xff << ((offset - 0x50 - i * 0x20) * 8)));
        s->l3_pm_rt_read_permission[i] |=
            (value << (offset - 0x50 - i * 0x20) * 8);
        break;
    case 0x58 ... 0x5b:
    case 0x78 ... 0x7b:
        i = (offset - 0x58) / 0x20;
        s->l3_pm_rt_write_permission[i] &=
            (~(0xff << ((offset - 0x58 - i * 0x20) * 8)));
        s->l3_pm_rt_write_permission[i] |=
            (value << (offset - 0x58 - i * 0x20) * 8);
        break;
    case 0x60 ... 0x63:
    ...
    case 0x2528 ... 0x252b:
        ...
        s->l3_pm_gpmc_req_info_permission[i] &=
            (~(0xff << ((offset - 0x2448 - i * 0x20) * 8)));
        s->l3_pm_gpmc_req_info_permission[i] |=
            (value << (offset - 0x2448 - i * 0x20) * 8);
        break;
    case 0x2450 ... 0x2453:
    case 0x2470 ... 0x2473:
    case 0x2490 ... 0x2493:
    ...
    case 0x2530 ... 0x2533:
        ...
        s->l3_pm_gpmc_read_permission[i] &=
            (~(0xff << ((offset - 0x2450 - i * 0x20) * 8)));
        s->l3_pm_gpmc_read_permission[i] |=
            (value << (offset - 0x2450 - i * 0x20) * 8);
        break;
    case 0x2458 ... 0x245b:
    case 0x2478 ... 0x247b:
    case 0x2498 ... 0x249b:
    ...
    case 0x2538 ... 0x253b:
        ...
        s->l3_pm_gpmc_write_permission[i] &=
            (~(0xff << ((offset - 0x2458 - i * 0x20) * 8)));
        s->l3_pm_gpmc_write_permission[i] |=
            (value << (offset - 0x2458 - i * 0x20) * 8);
        break;
    case 0x2848 ... 0x284b:
    case 0x2868 ... 0x286b:
    case 0x2888 ... 0x288b:
    ...
    case 0x2928 ... 0x292b:
        ...
        s->l3_pm_ocmram_req_info_permission[i] &=
            (~(0xff << ((offset - 0x2848 - i * 0x20) * 8)));
        s->l3_pm_ocmram_req_info_permission[i] |=
            (value << (offset - 0x2848 - i * 0x20) * 8);
        break;
    case 0x2850 ... 0x2853:
    case 0x2870 ... 0x2873:
    case 0x2890 ... 0x2893:
    ...
    case 0x2930 ... 0x2933:
        ...
        s->l3_pm_ocmram_read_permission[i] &=
            (~(0xff << ((offset - 0x2850 - i * 0x20) * 8)));
        s->l3_pm_ocmram_read_permission[i] |=
            (value << (offset - 0x2850 - i * 0x20) * 8);
        break;
    case 0x2858 ... 0x285b:
    case 0x2878 ... 0x287b:
    case 0x2898 ... 0x289b:
    ...
    case 0x2938 ... 0x293b:
        ...
        s->l3_pm_ocmram_write_permission[i] &=
            (~(0xff << ((offset - 0x2858 - i * 0x20) * 8)));
        s->l3_pm_ocmram_write_permission[i] |=
            (value << (offset - 0x2858 - i * 0x20) * 8);
        break;
    ...
    case 0x2920 ... 0x2923:
        ...
        s->l3_pm_ocmram_addr_match[i] &=
            (~(0xff << ((offset - 0x2860 - i * 0x20) * 8)));
        s->l3_pm_ocmram_addr_match[i] |=
            (value << (offset - 0x2860 - i * 0x20) * 8);
        break;
    ...
    case 0x40a8 ... 0x40ab:
        ...
        s->l3_pm_iva_req_info_permission[i] &=
            (~(0xff << ((offset - 0x4048 - i * 0x20) * 8)));
        s->l3_pm_iva_req_info_permission[i] |=
            (value << (offset - 0x4048 - i * 0x20) * 8);
        break;
    case 0x4050 ... 0x4053:
    case 0x4070 ... 0x4073:
    case 0x4090 ... 0x4093:
    case 0x40b0 ... 0x40b3:
        ...
        s->l3_pm_iva_read_permission[i] &=
            (~(0xff << ((offset - 0x4050 - i * 0x20) * 8)));
        s->l3_pm_iva_read_permission[i] |=
            (value << (offset - 0x4050 - i * 0x20) * 8);
        break;
    case 0x4058 ... 0x405b:
    case 0x4078 ... 0x407b:
    case 0x4098 ... 0x409b:
    case 0x40b8 ... 0x40bb:
        ...
        s->l3_pm_iva_write_permission[i] &=
            (~(0xff << ((offset - 0x4058 - i * 0x20) * 8)));
        s->l3_pm_iva_write_permission[i] |=
            (value << (offset - 0x4058 - i * 0x20) * 8);
        break;
    default:
...
struct omap3_pm_s *omap3_pm_init(struct omap_mpu_state_s *mpu)
{
    ...
    iomemtype = l4_register_io_memory(0, omap3_pm_readfn, omap3_pm_writefn, s);
...
#if 0
/* TEST-Chip-level TAP */
static uint32_t omap3_tap_read(void *opaque, target_phys_addr_t addr)
{
...
static void omap3_tap_write(void *opaque, target_phys_addr_t addr,
                uint32_t value)
{
    OMAP_BAD_REG(addr);
}
...
static CPUWriteMemoryFunc *omap3_tap_writefn[] = {
    omap_badwidth_write32,
    omap_badwidth_write32,
    omap3_tap_write,
};

void omap3_tap_init(struct omap_target_agent_s *ta,
                struct omap_mpu_state_s *mpu)
{
